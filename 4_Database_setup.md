...
For this database section we're going to take a short break from writing tests. We'll come back and write tests for this section later, and talk about why we waiting to write the tests.
